...
docker rmi -f nmsilva90s/protcapp-api
docker build . -f compose/django/Dockerfile --no-cache -t nmsilva90s/protcapp-api

docker login --username nmsilva90s -p 30ffa2f6-f7e8-4b64-a08a-386e82709ef2
docker push nmsilva90s/protcapp-api:latest
